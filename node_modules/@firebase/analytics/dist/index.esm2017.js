...
import { ErrorFactory, calculateBackoffMillis, FirebaseError, isBrowserExtension, areCookiesEnabled, isIndexedDBAvailable, validateIndexedDBOpenable } from '@firebase/util';
...
const ERRORS = {
    ...
    ["indexedDB-unsupported" /* INDEXED_DB_UNSUPPORTED */]: 'IndexedDB is not supported by current browswer',
    ["invalid-indexedDB-context" /* INVALID_INDEXED_DB_CONTEXT */]: "Environment doesn't support IndexedDB: {$errorInfo}. " +
        'Wrap initialization of analytics in analytics.isSupported() ' +
        'to prevent initialization in unsupported environments',
    ["cookies-not-enabled" /* COOKIES_NOT_ENABLED */]: 'Cookies are not enabled in this browser environment. Analytics requires cookies to be enabled.',
    ["invalid-analytics-context" /* INVALID_ANALYTICS_CONTEXT */]: 'Firebase Analytics is not supported in browser extensions.',
...
function factory(app, installations) {
    ...
    validateIndexedDBOpenable().catch(error => {
        const analyticsError = ERROR_FACTORY.create("invalid-indexedDB-context" /* INVALID_INDEXED_DB_CONTEXT */, {
            errorInfo: error
        });
