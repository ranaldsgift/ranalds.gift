...
function _(t) {
    ...
    if (E.logLevel <= s.DEBUG) {
        var i = e.map(D);
        E.debug.apply(E, r([ "Firestore (7.21.0): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (E.logLevel <= s.ERROR) {
        var i = e.map(D);
        E.error.apply(E, r([ "Firestore (7.21.0): " + t ], i));
    }
}
...
function A(t) {
    ...
    if (E.logLevel <= s.WARN) {
        var i = e.map(D);
        E.warn.apply(E, r([ "Firestore (7.21.0): " + t ], i));
    }
}
 ...
 */ var L = /** @class */ function() {
    ...
    n.P = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new I(b.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(L), V = /^[_a-zA-Z][_a-zA-Z0-9]*$/, C = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.o = function(t, e, r) {
 ...
 */ function H(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new I(b.INVALID_ARGUMENT, "Invalid value " + Z(r) + " provided to function " + t + "() for its " + nt(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
 ...
 */ var pt = /** @class */ function(e) {
    ...
    return t(n, e), n.fromBase64String = function(t) {
        q("Blob.fromBase64String", arguments, 1), B("Blob.fromBase64String", "string", 1, t), 
        lt();
        try {
 ...
 *     Code.UNKNOWN.
 */ (St = Dt || (Dt = {}))[St.OK = 0] = "OK", St[St.CANCELLED = 1] = "CANCELLED", 
...
var Ut = /** @class */ function() {
    ...
    t.prototype.lt = function() {
        return new Lt(this.root, null, this.i, !1);
    }, t.prototype._t = function(t) {
        return new Lt(this.root, t, this.i, !1);
    }, t.prototype.ft = function() {
        return new Lt(this.root, null, this.i, !0);
    }, t.prototype.dt = function(t) {
        return new Lt(this.root, t, this.i, !0);
    }, t;
}(), Lt = /** @class */ function() {
    function t(t, e, n, r) {
        this.wt = r, this.Tt = [];
...
var Bt = new Ut(M.i), Gt = new Vt(M.i);
 ...
 */ var Ht = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Mt = zt(), this.Ot = new Ut(this.i)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Jt.Xt(e, n)), new t(gt.min(), r, Kt(), Ft(), Qt());
    }, t;
}(), Jt = /** @class */ function() {
    function t(
    /**
...
/** Extracts the backend's type order for the provided value. */ function ce(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? se(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : S();
}
...
function Ge(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? wn.updateTime(Ue(t.updateTime)) : void 0 !== t.exists ? wn.exists(t.exists) : wn.Ge();
        ...
        var u = Ce(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                ...
                if ("setToServerValue" in e) x("REQUEST_TIME" === e.setToServerValue), n = new an; else if ("appendMissingElements" in e) {
                    ...
                    n = new fn(i);
                } else "increment" in e ? n = new pn(t, e.increment) : S();
...
function We(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Ke(e.startAt)), 
 ...
 */ function on(t, e, n) {
    return t instanceof an ? function(t, e) {
        ...
        return we(n) && we(t.We) ? De(r) : Se(t.serializer, r);
    }(t, e);
}
 ...
 */ function Zn(t) {
    var e = k(t);
    if (!e.cn) if ("F" /* First */ === e.on) e.cn = Tt(e.path, e.collectionGroup, Xn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Xn(e); r < i.length; r++) {
        ...
        // Now return as a LimitType.First query.
                e.cn = Tt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.cn;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function ir(t, e) {
    return function(t, e) {
        ...
        return !(t.startAt && !mr(t.startAt, Xn(t), e)) && (!t.endAt || !mr(t.endAt, Xn(t), e));
    }(t, e);
}
 ...
 */ var Er = function() {
    ...
    t.prototype.Rn = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && _("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Tn + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Sn && S(), this.Sn = !0, this.vn ? this.error ? this.Dn(n, this.error) : this.Cn(e, this.result) : new t((function(t, i) {
            r.pn = function(n) {
                r.Cn(e, n).next(t, i);
            }, r.bn = function(e) {
                r.Dn(n, e).next(t, i);
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return _("SimpleDb", "Removing database:", t), Or(window.indexedDB.deleteDatabase(t)).Nn();
    }, 
    ...
    t.prototype.Qn = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.db ? [ 3 /*break*/ , 2 ] : (_("SimpleDb", "Opening database:", this.name), 
                    t = this, [ 4 /*yield*/ , new Promise((function(t, n) {
                        ...
                        r.onsuccess = function(e) {
                            ...
                            n(new Dr("Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, r.onerror = function(t) {
                            var e = t.target.error;
                            "VersionError" === e.name ? n(new I(b.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Dr(e));
                        }, r.onupgradeneeded = function(t) {
                            _("SimpleDb", 'Database "' + e.name + '" requires upgrade from version:', t.oldVersion);
                            var n = t.target.result;
                            e.kn.createOrUpgrade(n, r.transaction, t.oldVersion, e.version).next((function() {
                                _("SimpleDb", "Database upgrade to version " + e.version + " complete");
                            }));
                        };
                    })) ]);
                    ...
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 4:
                                return c = n.sent(), h = "FirebaseError" !== c.name && o < 3, _("SimpleDb", "Transaction failed with error:", c.message, "Retrying:", h), 
 ...
 */ var xr = /** @class */ function() {
    function t(t) {
        ...
        this.Xn = new Er, this.transaction.oncomplete = function() {
            ...
            t.error ? e.Xn.reject(new Dr(t.error)) : e.Xn.resolve();
        }, this.transaction.onerror = function(t) {
            var n = Ur(t.target.error);
            e.Xn.reject(new Dr(n));
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this.Xn.reject(t), this.aborted || (_("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    t.prototype.add = function(t) {
        return _("SimpleDb", "ADD", this.store.name, t, t), Or(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return _("SimpleDb", "DELETE", this.store.name, t), Or(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return _("SimpleDb", "COUNT", this.store.name), Or(this.store.count());
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Lr() {
 ...
 */ var Vr = /** @class */ function() {
    ...
    function t() {
        ...
        this.gs = new Tr(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.ys = function() {
            var e = Pr();
            e && _("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.gs.yn();
        };
        var e = Pr();
 ...
 */
function Mr(t, e) {
    if (N("AsyncQueue", e + ": " + t), Sr(t)) return new I(b.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Wr = /** @class */ function() {
    ...
    return t.prototype.Qs = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Xt(t.query, t.docs, t.Ut, e, t.Qt, t.fromCache, t.Wt, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Us = function(t) {
        ...
        t = Xt.Kt(t.query, t.docs, t.Qt, t.fromCache), this.Ks = !0, this.js.next(t);
    }, t;
}(), Kr = /** @class */ function() {
    function t(t) {
        this.uid = t;
 ...
 * readable.
 */
/** A user with a null UID. */ Kr.UNAUTHENTICATED = new Kr(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
Kr.ti = new Kr("google-credentials-uid"), Kr.ei = new Kr("first-party-uid");
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function Xr(t, e, n) {
...
var Jr = /** @class */ function() {
    ...
    return t.ai = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Kt(), s = 0; i && s < r.activeTargetIds.length; ++s) i = It(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.fi = null, this.ni = null, this.di = this.wi.bind(this), this.mi = new Ut(st), 
        this.Ti = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Ii = Yr(this.persistenceKey, this.li), 
        this.Ai = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.On = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.li && (o = this.getItem(Yr(this.persistenceKey, i))) && (s = ti.ai(i, o)) && (this.mi = this.mi.rt(s.clientId, s));
        ...
        // `Window.addEventListener`.
            ...
            if (_("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Ii) return void N("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this._n.Ds((function() {
        ...
        var r = new Jr(this.currentUser, t, e, n), i = Xr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.ci());
        ...
        var r = Zr(this.persistenceKey, t), i = new $r(t, e, n);
        this.setItem(r, i.ci());
    }, 
    /**
    ...
    t.prototype.bi = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this._i.tr(t.batchId, t.state, t.error) ] : (_("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    t.prototype.ur = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Tn(i, e, e, this.rr));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Tn(a, e, o, this.rr));
        }
        return e;
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = Bt, o = e.mutations, s = 0; s < o.length; s++) i = i.rt(o[s].key, r[s].version);
    ...
    t.prototype.Ar = function(t, e) {
        this.Er();
        var n = this.dr.get(e);
        return void 0 !== n ? _r.resolve(n) : this.Rr(t, e);
    }, 
    /**
 ...
 */
        return function(t) {
            return M.F(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Lr(t, e.path) : Yn(e) ? this.Br(t, e, n) : this.qr(t, e, n);
        ...
        return this.Sr.Ur(t, i).next((function(s) {
            return _r.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new zn(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Wr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Tn(a, h, h, o.rr);
...
var yi = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        _("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.mo = this.os.gn("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Sr(e = n.sent()) ? (_("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Po = function(t, e) {
        var n = this;
        if (0 === e) return _r.resolve(Hr.oi);
        var r = new pi(e);
    ...
    t.prototype.po = function(t, e) {
        ...
        var n = this;
        return this.params.so === vi.uo ? (_("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        _r.resolve(di)) : this.vo(t).next((function(r) {
            return r < n.params.so ? (_("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.so), 
            di) : n.So(t, e);
        }));
        ...
        return this.Ao(t, this.params.io).next((function(e) {
            ...
            return e > h.params.ro ? (_("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.params.ro + " from " + e), 
            ...
            return c = Date.now(), T() <= s.DEBUG && _("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), 
            _r.resolve({
                Xr: !0,
                Zr: r,
                eo: i,
...
/** Decodes a remote document from storage locally to a Document. */ function Ti(t, e) {
    if (e.document) return function(t, e, n) {
        var r = Ce(t, e.name), i = Ue(e.updateTime), o = new Pn({
            mapValue: {
                fields: e.fields
            }
        });
    ...
    if (e.noDocument) {
        var n = M.$(e.noDocument.path), r = Si(e.noDocument.readTime);
        return new qn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = M.$(e.unknownDocument.path), o = Si(e.unknownDocument.version);
        return new jn(i, o);
    }
    return S();
}

/** Encodes a document for storage locally. */ function _i(t, e, n) {
    ...
    if (e instanceof qn) {
        var u = e.key.path.A(), a = Di(e.version), c = e.hasCommittedMutations;
        return new $i(
        /* unknownDocument= */ null, new Zi(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e instanceof jn) {
        var h = e.key.path.A(), f = Di(e.version);
        return new $i(new Ji(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbTarget into TargetData */ function ki(t) {
    var e, n, r = Si(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Si(t.lastLimboFreeSnapshotVersion) : gt.min();
    return void 0 !== t.query.documents ? (x(1 === (n = t.query).documents.length), 
    e = Zn(Gn(Fe(n.documents[0])))) : e = function(t) {
        ...
        n.where && (s = function t(e) {
            return e ? void 0 !== e.unaryFilter ? [ tn(e) ] : void 0 !== e.fieldFilter ? [ $e(e) ] : void 0 !== e.compositeFilter ? e.compositeFilter.filters.map((function(e) {
                return t(e);
            })).reduce((function(t, e) {
                return t.concat(e);
            })) : S() : [];
        ...
        var h = null;
        return n.endAt && (h = He(n.endAt)), Zn(Bn(e, i, u, s, a, "F" /* First */ , c, h));
    }(t.query), new xt(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ct.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Oi(t, e) {
    var n, r = Di(e.et), i = Di(e.lastLimboFreeSnapshotVersion);
    n = At(e.target) ? Qe(t.Do, e.target) : We(t.Do, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new eo(e.targetId, _t(e.target), r, o, e.sequenceNumber, i, n);
}
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Ri = /** @class */ function() {
    ...
    return t.Fo = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            ...
            for (var a = new oi(u, e, n, r), c = function(t, e, n) {
                ...
                return new Yi(e, n.batchId, n.rr.toMillis(), r, i);
            }(i.serializer, i.userId, a), h = [], f = new Vt((function(t, e) {
                return st(t.R(), e.R());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], v = Xi.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.h()), h.push(s.put(c)), h.push(o.put(v, Xi.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.Sr.ko(t, e));
            })), t.Vr((function() {
                i.No[u] = a.keys();
            })), _r.xn(h).next((function() {
                return a;
            }));
        }));
    ...
    t.prototype.Oo = function(t, e) {
        var n = this;
        return this.No[e] ? _r.resolve(this.No[e]) : this.Mo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.No[e] = r, r;
            }
        ...
        return Pi(t).Zn(Yi.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return xi(e.serializer, t);
            }));
        }));
    }, t.prototype.Cr = function(t, e) {
        var n = this, r = Xi.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        ...
        return e.forEach((function(e) {
            var o = Xi.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Vi(t).ss({
                range: s
            }, (function(t, i, o) {
            ...
            i.push(u);
        })), _r.xn(i).next((function() {
            return n.Uo(t, r);
        }));
    }, t.prototype.Qr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Xi.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Vt(st);
        return Vi(t).ss({
            range: s
        }, (function(t, e, o) {
        ...
        var n = this;
        return Li(t.Wo, this.userId, e).next((function(r) {
            return t.Vr((function() {
                n.jo(e.batchId);
            })), _r.forEach(r, (function(e) {
                return n.Co.Ko(t, e);
            }));
        }));
    }, 
    ...
    t.prototype.jo = function(t) {
        ...
        return this.xo(t).next((function(n) {
            if (!n) return _r.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Xi.prefixForUser(e.userId)), i = [];
            return Vi(t).ss({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
 ...
 */ function Ui(t, e, n) {
    var r = Xi.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Vi(t).ss({
        range: o,
        ns: !0
    }, (function(t, n, r) {
 ...
 */ function Li(t, e, n) {
    var r = t.store(Yi.store), i = t.store(Xi.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.ss({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], p = Xi.key(e, l.key.path, n.batchId);
        o.push(i.delete(p)), c.push(l.key);
    }
    return _r.xn(o).next((function() {
        return c;
    }));
}
 ...
 */ var Mi = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return qi(t).get(ji(e)).next((function(t) {
            return n.Jo(t);
        }));
    }, 
    /**
    ...
    t.prototype.ea = function(t, e) {
        var n = this, r = qt(), i = new Ut(M.i);
        return this.ta(t, e, (function(t, e) {
            var o = n.Jo(e);
            o ? (r = r.rt(t, o), i = i.rt(t, zi(e))) : (r = r.rt(t, null), i = i.rt(t, 0));
        })).next((function() {
            return {
                na: r,
                sa: i
        ...
        if (n.isEqual(gt.min())) {
            ...
            /* open= */ !0), s.index = $i.collectionReadTimeIndex;
        }
    ...
    t.prototype.ia = function(t, e) {
        ...
        return o.ss({
            index: $i.readTimeIndex,
            range: s
        }, (function(t, e) {
            // Unlike `getEntry()` and others, `getNewDocumentChanges()` parses
            // the documents directly since we want to keep sentinel deletes.
            var o = Ti(n.serializer, e);
 ...
 */ Mi.ca = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.gr = function(t) {
        ...
        return this.dr.forEach((function(o, s) {
            var u = e._a.get(o);
            if (s) {
                var a = _i(e.la.serializer, s, e.readTime);
                i = i.add(o.path.h());
                var c = zi(a);
                ...
                var h = _i(e.la.serializer, new qn(o, gt.min()), e.readTime);
                n.push(e.la.Tr(t, o, h));
            } else n.push(e.la.Ir(t, o));
        })), i.forEach((function(r) {
            n.push(e.la.Sr.ko(t, r));
        })), n.push(this.la.updateMetadata(t, r)), _r.xn(n);
...
var Bi = /** @class */ function() {
    ...
    return t.prototype.ko = function(t, e) {
        return this.fa.add(e), _r.resolve();
    }, t.prototype.Ur = function(t, e) {
        return _r.resolve(this.fa.getEntries(e));
    }, t;
}(), Gi = /** @class */ function() {
    function t() {
        this.index = {};
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Yi.store).Zn().next((function(n) {
                    t.deleteObjectStore(Yi.store), t.createObjectStore(Yi.store, {
                        keyPath: Yi.keyPath,
                        autoIncrement: !0
                    }).createIndex(Yi.userMutationsIndex, Yi.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(Yi.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return _r.xn(i);
                }));
            ...
            !function(t) {
                ...
                var e = t.objectStore($i.store);
                e.createIndex($i.readTimeIndex, $i.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex($i.collectionReadTimeIndex, $i.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store($i.store).ss((function(t, n) {
            e += zi(n);
        })).next((function() {
            var n = new to(e);
        ...
        var e = this, n = t.store(Hi.store), r = t.store(Yi.store);
        return n.Zn().next((function(n) {
            return _r.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Zn(Yi.userMutationsIndex, i).next((function(r) {
                    return _r.forEach(r, (function(r) {
                        x(r.userId === n.userId);
                        var i = xi(e.serializer, r);
                        return Li(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(no.store), n = t.store($i.store);
        return t.store(ro.store).get(ro.key).next((function(t) {
            ...
            return n.ss((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? _r.resolve() : function(n) {
        ...
        var n = e.store(io.store), r = new Gi, i = function(t) {
            if (r.add(t)) {
                var e = t._(), i = t.h();
                return n.put({
                    collectionId: e,
...
/** Name of the IndexedDb object store.  */ Hi.store = "mutationQueues", 
...
/**
     ...
     */
$i.readTimeIndex = "readTimeIndex", $i.readTimeIndexPath = "readTime", 
/**
     ...
     */
$i.collectionReadTimeIndex = "collectionReadTimeIndex", $i.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
var uo = r(r(r([ Hi.store, Yi.store, Xi.store, $i.store, eo.store, Ki.store, ro.store, no.store ], [ so.store ]), [ to.store ]), [ io.store ]), ao = /** @class */ function() {
    function t() {
        /**
 ...
 */ var ho = /** @class */ function() {
    ...
    t.prototype.pa = function(t, e) {
        ...
        var n = _t(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return lo(t).ss({
            range: r,
        ...
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return _r.forEach(e, (function(e) {
            var o = gi(e.path);
            return _r.xn([ i.delete([ n, o ]), r.Co.$a(t, n, e) ]);
        }));
 ...
 */ var yo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", mo = /** @class */ function(e) {
    ...
    t.prototype.Ja = function() {
        ...
        var e = this;
        return wo(t).get(Ki.key).next((function(t) {
            return _r.resolve(e.cc(t));
        }));
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(e) {
                        ...
                        return n.Zn().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return _r.forEach(r, (function(t) {
    ...
    t.prototype.rc = function(t) {
        var e = this;
        return this.La ? _r.resolve(!0) : wo(t).get(Ki.key).next((function(n) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.Tc(), [ 4 /*yield*/ , this.za.runTransaction("readwrite", [ Ki.store, so.store ], (function(e) {
                        var n = new mo(e, Hr.oi);
    ...
    t.prototype.Vi = function() {
        ...
        return this.za.runTransaction(o, uo, (function(o) {
            return i = new mo(o, r.Ba ? r.Ba.next() : Hr.oi), "readwrite-primary" === e ? r.ic(i).next((function(t) {
                return !!t || r.rc(i);
            })).next((function(e) {
    ...
    t.prototype.ac = function(t) {
        var e = new Ki(this.clientId, this.allowTabSynchronization, Date.now());
        return wo(t).put(Ki.key, e);
    }, t.On = function() {
        return Nr.On();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.oc = function(t) {
        var e = this, n = wo(t);
        return n.get(Ki.key).next((function(t) {
            return e.cc(t) ? (_("IndexedDbPersistence", "Releasing primary lease."), n.delete(Ki.key)) : _r.resolve();
        }));
    }, 
 ...
 */ function No(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = _r.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.Ar(e, t);
                })).next((function(e) {
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Ht.forEach((function(a, c) {
                ...
                u = u.rt(a, c)) : _("LocalStore", "Ignoring outdated watch update for ", a, ". Current version:", h.version, " Watch version:", c.version), 
 ...
 */ function xo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ha.Ca(t, e).next((function(i) {
            ...
            r = i, _r.resolve(r)) : n.Ha.Ea(t).next((function(i) {
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 4:
                if (!Sr(u = n.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return _("LocalStore", "Failed to update sequence numbers for target " + r + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function Oo(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return void 0 !== i ? _r.resolve(r.Dc.get(i)) : r.Ha.Ca(e, n);
 ...
 */ var Lo = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.currentUser = Kr.UNAUTHENTICATED, this.tu = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.eu !== e ? (_("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
    ...
    t.prototype.nu = function() {
        ...
        return x(null === t || "string" == typeof t), new Kr(t);
    }, t;
}(), Fo = /** @class */ function() {
    function t(t, e) {
        this.su = t, this.iu = e, this.type = "FirstParty", this.user = Kr.ei;
    }
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.uu = 0, this.hu = null, this.stream = null, this.gs = new Tr(t, e)
        /**
    ...
    /** Sends a message to the underlying stream. */ t.prototype.Tu = function(t) {
        this.Eu(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.mu = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
    ...
    /** Marks the stream as active again. */ t.prototype.Eu = function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Au(r) ];
    ...
    t.prototype.Ru = function(t) {
        ...
        return function(n) {
            e._n.ds((function() {
                return e.uu === t ? n() : (_("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.yu = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var c = Ce(t, a.document.name), h = Ue(a.document.updateTime), f = new Pn({
                    mapValue: {
                ...
                v.document;
                var y = Ce(t, v.document), m = v.readTime ? Ue(v.readTime) : gt.min(), g = new qn(y, m), w = v.removedTargetIds || [];
                n = new $t([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var E = e.documentRemove;
                E.document;
                var T = Ce(t, E.document), _ = E.removedTargetIds || [];
                n = new $t([], _, T, null);
            } else {
                ...
                var N = e.filter;
                N.targetId;
                var A = N.count || 0, D = new kt(A), k = N.targetId;
                n = new te(k, D);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? gt.min() : e.readTime ? Ue(e.readTime) : gt.min();
        }(t);
    ...
    n.prototype.Su = function(t) {
        var e = {};
        e.database = qe(this.serializer), e.removeTarget = t, this.Tu(e);
    }, n;
}(jo), Bo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Cu", {
        /**
    ...
    n.prototype.start = function() {
        ...
        x(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Du) {
        ...
        // The first response is always the handshake response
                return x(!t.writeResults || 0 === t.writeResults.length), this.Du = !0, 
        this.listener.xu();
    }, 
    /**
    ...
    n.prototype.$u = function() {
        ...
        var t = {};
        t.database = qe(this.serializer), this.Tu(t);
    }, 
    ...
    return t(n, e), n.prototype.Mu = function() {
        if (this.ku) throw new I(b.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Uu ? (N(e), this.Uu = !1) : _("OnlineStateTracker", e);
...
r, i, o, s) {
    var u = this;
    this.zu = t, this.Hu = r, this.os = i, this.Yu = {}, 
    /**
    ...
    /**
             ...
             */
    this.th = [], this.eh = s, this.eh.nh((function(t) {
        i.ds((function() {
            return e(u, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ns(this) ? (_("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = k(t)).Zu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Ho(e) ];

                                      case 1:
                                        return n.sent(), e.sh.set("Unknown" /* Unknown */), e.Zu.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , Ko(e) ];
...
function Yo(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), _("RemoteStore", "RemoteStore shutting down."), e.Zu.add(5 /* Shutdown */), 
                [ 4 /*yield*/ , Ho(e) ];

              case 1:
                return n.sent(), e.eh.Si(), 
 ...
 */ function Zo(t, e) {
    var n = k(t), r = ms(n);
    n.Xu.delete(e), r._u() && $o(n, e), 0 === n.Xu.size && (r._u() ? r.wu() : ns(n) && 
...
function es(t) {
    return ns(t) && !ms(t).lu() && t.Xu.size > 0;
}

function ns(t) {
    return 0 === k(t).Zu.size;
}
...
function is(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            return t.Xu.forEach((function(e, n) {
                Jo(t, e);
            })), [ 2 /*return*/ ];
        }));
    }));
...
function os(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            ...
            t.sh.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function ss(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.sh.set("Online" /* Online */), !(r instanceof ee && 2 /* Removed */ === r.state && r.cause)) 
                    ...
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], t.Xu.has(s) ? [ 4 /*yield*/ , t.Yu.rh(s, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                n.sent(), t.Xu.delete(s), t.ih.removeTarget(s), n.label = 3;
              ...
              case 3:
                return o = a.sent(), _("RemoteStore", "Failed to remove targets %s: %s ", r.targetIds.join(","), o), 
                [ 4 /*yield*/ , us(t, o) ];
              ...
              case 6:
                if (r instanceof $t ? t.ih.pe(r) : r instanceof te ? t.ih.xe(r) : t.ih.Se(r), i.isEqual(gt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Ao(t.zu) ];
              ...
              case 11:
                return _("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , us(t, u) ];
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Zu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ho(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t.sh.set("Offline" /* Offline */), i || (
                ...
                t.os.Ds((function() {
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return _("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , i() ];

                              case 1:
                                return e.sent(), t.Zu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ko(t) ];
...
function cs(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = k(t), r = gs(e), i = e.Ju.length > 0 ? e.Ju[e.Ju.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , So(e.zu, i) ];

              case 3:
                return null === (o = n.sent()) ? (0 === e.Ju.length && r.wu(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Ju.push(e);
                    var n = gs(t);
...
function hs(t) {
    return ns(t) && !gs(t).lu() && t.Ju.length > 0;
}
...
function ps(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = gs(t), r = 0, i = t.Ju; r < i.length; r++) o = i[r], e.Nu(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function ds(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.Ju.shift(), o = si.from(e, r, i), [ 4 /*yield*/ , as(t, (function() {
                    return t.Yu.ah(o);
                })) ];
...
function vs(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(i) {
            switch (i.label) {
              case 0:
                return r && gs(t).Cu ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return Ot(i = r.code) && i !== b.ABORTED ? (e = t.Ju.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                gs(t).du(), [ 4 /*yield*/ , as(t, (function() {
                                    return t.Yu.uh(e.batchId, r);
                                })) ]) : [ 3 /*break*/ , 3 ];
 ...
 */ function ys(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), r ? (e.Zu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Ko(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = r) ? [ 3 /*break*/ , 4 ] : (e.Zu.add(2 /* IsSecondary */), [ 4 /*yield*/ , Ho(e) ]);

              case 3:
                n.sent(), i = e.sh.set("Unknown" /* Unknown */), n.label = 4;
 ...
 */ function ms(t) {
    ...
    t.hh = function(t, e, n) {
        var r = k(t);
        return r.Mu(), new zo(e, r.au, r.credentials, r.serializer, n);
    }(t.Hu, t.os, {
        Vu: is.bind(null, t),
        Au: os.bind(null, t),
        bu: ss.bind(null, t)
    }), t.th.push((function(i) {
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.hh.du(), es(t) ? ts(t) : t.sh.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function gs(t) {
    ...
    t.lh = function(t, e, n) {
        var r = k(t);
        return r.Mu(), new Bo(e, r.au, r.credentials, r.serializer, n);
    }(t.Hu, t.os, {
        Vu: ls.bind(null, t),
        Au: vs.bind(null, t),
        xu: ps.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.lh.du(), [ 4 /*yield*/ , cs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , t.lh.stop() ];

                  case 3:
                    e.sent(), t.Ju.length > 0 && (_("RemoteStore", "Stopping write stream with " + t.Ju.length + " pending writes"), 
                    t.Ju = []), e.label = 4;
...
var ws = function(t) {
    ...
    e) {
        ...
        this.Qt = Qt(), this.wh = or(t), this.mh = new Ht(this.wh);
    }
    ...
    t.prototype.Eh = function(t, e) {
        var n = this, r = e ? e.Ih : new Yt, i = e ? e.mh : this.mh, o = e ? e.Qt : this.Qt, s = i, u = !1, a = Qn(this.query) && i.size === this.query.limit ? i.last() : null, c = Wn(this.query) && i.size === this.query.limit ? i.first() : null;
        ...
        if (t.ut((function(t, e) {
            ...
            o = o.delete(t)));
        })), Qn(this.query) || Wn(this.query)) for (;s.size > this.query.limit; ) {
    ...
    t.prototype.gr = function(t, e, n) {
        ...
        return this.fh = u, 0 !== o.length || a ? {
            snapshot: new Xt(this.query, t.mh, i, o, t.Qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            yh: s
        } : {
            yh: s
    ...
    t.prototype.Ph = function(t) {
        ...
        // updating many documents.
                var e = this.dh;
        this.dh = Qt(), this.mh.forEach((function(e) {
            t.Vh(e.key) && (t.dh = t.dh.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.dh.has(e) || n.push(new bs(e));
    ...
    t.prototype.bh = function() {
        return Xt.Kt(this.query, this.mh, this.Qt, 0 /* Local */ === this.fh);
    }, t;
}(), Es = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.xh = {}, this.$h = new yt((function(t) {
            return nr(t);
        }), er), this.kh = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Lh = new Map, this.Bh = new Lo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.qh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Uh = new Map, this.Qh = ho.Ta(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                i = s.targetId, e.Nh.Mi(i), o = s.view.bh(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , xo(e.zu, Zn(r)) ];

              case 2:
                return u = n.sent(), a = e.Nh.Mi(u.targetId), i = u.targetId, [ 4 /*yield*/ , As(e, r, i, "current" === a) ];

              case 3:
                o = n.sent(), e.jh && Xo(e.Dh, u), n.label = 4;
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(l) {
            switch (l.label) {
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.Eh(i), e.Rh ? [ 4 /*yield*/ , Oo(t.zu, r.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var n = t.documents;
                                        return r.view.Eh(n, e);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.jh, s), [ 2 /*return*/ , (Cs(t, r.targetId, u.yh), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return s = l.sent(), u = new Is(r, s.kc), a = u.Eh(s.documents), c = Jt.Xt(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.gr(a, 
                /* updateLimboDocuments= */ t.jh, c), Cs(t, i, h.yh), f = new Es(r, i, u), [ 2 /*return*/ , (t.$h.set(r, f), 
...
/** Stops listening to the query. */ function Ds(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), i = e.$h.get(r), (o = e.kh.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.kh.set(i.targetId, o.filter((function(t) {
                    return !er(t, r);
                }))), void e.$h.delete(r)) ] : e.jh ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                e.Nh.Li(i.targetId), e.Nh.Ni(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , ko(e.zu, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    e.Nh.qi(i.targetId), Zo(e.Dh, i.targetId), Ps(e, i.targetId);
                })).catch(Uo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Ps(e, i.targetId), [ 4 /*yield*/ , ko(e.zu, i.targetId, 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Do(e.zu, r) ];
              ...
              case 2:
                ...
                r.Gt.forEach((function(t, n) {
                    ...
                    x(t.te.size + t.ee.size + t.ne.size <= 1), t.te.size > 0 ? r.Sh = !0 : t.ee.size > 0 ? x(r.Sh) : t.ne.size > 0 && (x(r.Sh), 
                    r.Sh = !1));
                })), [ 4 /*yield*/ , qs(e, i, r) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = k(t)).Nh.Ui(r, "rejected", i), o = e.Lh.get(r), (s = o && o.key) ? (u = (u = new Ut(M.i)).rt(s, new qn(s, gt.min())), 
                a = Qt().add(s), c = new Zt(gt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Vt(st), u, a), [ 4 /*yield*/ , Ss(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.Oh = e.Oh.remove(s), e.Lh.delete(r), Fs(e), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , ko(e.zu, r, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Ps(e, r, i);
                })).catch(Uo) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , No(e.zu, r) ];
              ...
              case 2:
                ...
                Ls(e, i, /*error=*/ null), Us(e, i), e.Nh.$i(i, "acknowledged"), [ 4 /*yield*/ , qs(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                // listen events.
                Ls(e, r, i), Us(e, r), e.Nh.$i(r, "rejected", i), [ 4 /*yield*/ , qs(e, o) ];
...
function Ls(t, e, n) {
    var r = k(t), i = r.qh[r.currentUser.Zs()];
...
function Vs(t, e) {
    ...
    var n = t.Oh.get(e);
    null !== n && (Zo(t.Dh, n), t.Oh = t.Oh.remove(e), t.Lh.delete(n), Fs(t));
}

function Cs(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof ws ? (t.Bh.Fa(o.key, e), Ms(t, o)) : o instanceof bs ? (_("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Ms(t, e) {
    var n = e.key;
    t.Oh.get(n) || (_("SyncEngine", "New document in limbo: " + n), t.Mh.push(n), Fs(t));
}
 ...
 */ function Fs(t) {
    for (;t.Mh.length > 0 && t.Oh.size < t.Fh; ) {
        ...
        t.Lh.set(n, new Ts(e)), t.Oh = t.Oh.rt(e, n), Xo(t.Dh, new xt(Zn(Gn(e.path)), n, 2 /* LimboResolution */ , Hr.oi));
    }
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = k(t), s = [], u = [], a = [], o.$h.m() ? [ 3 /*break*/ , 3 ] : (o.$h.forEach((function(t, e) {
                    a.push(o.Kh(e, r, i).then((function(t) {
                        if (t) {
                            o.jh && o.Nh.Ui(e.targetId, t.fromCache ? "not-current" : "current"), s.push(t);
              ...
              case 1:
                return c.sent(), o.xh.bu(s), [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                            ...
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return _r.forEach(r, (function(n) {
                                        return _r.forEach(n.jr, (function(r) {
                                            return e.persistence.Co.Fa(t, n.targetId, r);
                                        })).next((function() {
                                            return _r.forEach(n.Kr, (function(r) {
                              ...
                              case 3:
                                if (!Sr(i = n.sent())) throw i;
                                // If `notifyLocalViewChanges` fails, we did not advance the sequence
                                // number for the documents that were included in this transaction.
                                // This might trigger them to be deleted earlier than they otherwise
                                // would have, but it should not invalidate the integrity of the data.
                                                                return _("LocalStore", "Failed to update sequence numbers: " + i), 
                                [ 3 /*break*/ , 4 ];
...
function js(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                return (i = k(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (_("SyncEngine", "User change. New user:", r.Zs()), 
                [ 4 /*yield*/ , 
                /**
                ...
                function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return e = k(t), i = e.vr, o = e.xc, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
              ...
              case 1:
                ...
                i.Nh.Wi(r, o.Hh, o.Yh), [ 4 /*yield*/ , qs(i, o.zh) ];
...
function zs(t, e) {
    var n = k(t), r = n.Lh.get(e);
    if (r && r.Sh) return Qt().add(r.key);
    var i = Qt(), o = n.kh.get(e);
    if (!o) return i;
 ...
 */ function Bs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Oo((e = k(t)).zu, r.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = n.sent(), o = r.view.ph(i), [ 2 /*return*/ , (e.jh && Cs(e, r.targetId, o.yh), 
                o) ];
            }
        }));
    }));
        ...
        return n(this, (function(n) {
            switch (n.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Oo(t, e).next((function(e) {
                            return e ? n.xc.$r(t, e) : _r.resolve(null);
                        }));
                    }));
                }((e = k(t)).zu, r) ];

              case 1:
                return null === (s = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , cs(e.Dh) ];
              ...
              case 6:
                ...
                // as applicable.
                _("SyncEngine", "Cannot apply mutation batch with id: " + r), n.label = 7;
...
function Qs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return Zs(e = k(t)), Js(e), !0 !== r || !0 === e.Wh ? [ 3 /*break*/ , 3 ] : (i = e.Nh.Di(), 
                [ 4 /*yield*/ , Ws(e, i.A()) ]);

              case 1:
                return o = n.sent(), e.Wh = !0, [ 4 /*yield*/ , ys(e.Dh, !0) ];

              case 2:
                for (n.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Xo(e.Dh, a);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== r || !1 === e.Wh ? [ 3 /*break*/ , 7 ] : (c = [], h = Promise.resolve(), 
                e.kh.forEach((function(t, n) {
                    e.Nh.Bi(n) ? c.push(n) : h = h.then((function() {
                        return Ps(e, n), ko(e.zu, n, 
                        /*keepPersistedTargetData=*/ !0);
                    })), Zo(e.Dh, n);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return n.sent(), [ 4 /*yield*/ , Ws(e, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Lh.forEach((function(t, n) {
                        Zo(e.Dh, n);
                    })), e.Bh.jc(), e.Lh = new Map, e.Oh = new Ut(M.i);
                }(e), e.Wh = !1, [ 4 /*yield*/ , ys(e.Dh, !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = e.kh.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , xo(e.zu, Zn(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (p = l[f], d = e.$h.get(p), [ 4 /*yield*/ , Bs(e, d) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Ro(e.zu, a) ];

              case 8:
                return y = n.sent(), [ 4 /*yield*/ , xo(e.zu, y) ];

              case 9:
                return c = n.sent(), [ 4 /*yield*/ , As(e, Ks(y), a, 
                /*current=*/ !1) ];
...
function Hs(t) {
    var e = k(t);
    return k(k(e.zu).persistence).Vi();
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 3:
                return s = n.sent(), u = Zt.Jt(r, "current" === i), [ 4 /*yield*/ , qs(e, s, u) ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Xs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        var e, o, s, u, a, c, h, f, l, p;
        return n(this, (function(d) {
            switch (d.label) {
              case 0:
                if (!(e = Zs(t)).Wh) return [ 3 /*break*/ , 10 ];
                o = 0, s = r, d.label = 1;

              case 1:
                return o < s.length ? (u = s[o], e.kh.has(u) ? (
                // A target might have been added in a previous attempt
                _("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Ro(e.zu, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = d.sent(), [ 4 /*yield*/ , xo(e.zu, a) ];

              case 3:
                return c = d.sent(), [ 4 /*yield*/ , As(e, Ks(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                d.sent(), Xo(e.Dh, c), d.label = 5;
              ...
              case 6:
                h = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.kh.has(t) ? [ 4 /*yield*/ , ko(e.zu, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Zo(e.Dh, t), Ps(e, t);
                            })).catch(Uo) ] : [ 3 /*break*/ , 2 ];
...
function Zs(t) {
    var e = k(t);
    return e.Dh.Yu.oh = Ss.bind(null, e), e.Dh.Yu.Be = zs.bind(null, e), e.Dh.Yu.rh = ks.bind(null, e), 
    e.xh.bu = Br.bind(null, e.Ch), e.xh.Gh = Gr.bind(null, e.Ch), e;
}

function Js(t) {
    var e = k(t);
    return e.Dh.Yu.ah = Os.bind(null, e), e.Dh.Yu.uh = Rs.bind(null, e), e;
}
 ...
 */ var $s = /** @class */ function() {
    ...
    return t.prototype.$c = function(t) {
        ...
        }(e) || n.isEqual(gt.min()) ? this.Xh(t, e) : this.Jh.$r(t, r).next((function(o) {
            var u = i.Zh(e, o);
            return (Qn(e) || Wn(e)) && i.Rh(e.on, u, r, n) ? i.Xh(t, e) : (T() <= s.DEBUG && _("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), rr(e)), 
            i.Jh.Or(t, e, n).next((function(t) {
    ...
    t.prototype.Rh = function(t, e, n, r) {
        ...
        return T() <= s.DEBUG && _("IndexFreeQueryEngine", "Using full collection scan to execute query:", rr(e)), 
        this.Jh.Or(t, e, gt.min());
    }, t;
}(), tu = /** @class */ function() {
    function t(t, e) {
        this.Sr = t, this.Co = e, 
        ...
        this.el = new Vt(Po.Oc);
    }
    return t.prototype.xo = function(t) {
        return _r.resolve(0 === this.vr.length);
    }, t.prototype.$o = function(t, e, n, r) {
        var i = this.tl;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.el = this.el.add(new Po(a.key, i)), this.Sr.ko(t, a.key.path.h());
        }
        return _r.resolve(o);
    }, t.prototype.Mo = function(t, e) {
        return _r.resolve(this.nl(e));
    }, t.prototype.Lo = function(t, e) {
        var n = e + 1, r = this.sl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return _r.resolve(this.vr.length > i ? this.vr[i] : null);
    }, t.prototype.Bo = function() {
        return _r.resolve(0 === this.vr.length ? -1 : this.tl - 1);
    }, t.prototype.qo = function(t) {
        return _r.resolve(this.vr.slice());
    }, t.prototype.Cr = function(t, e) {
        ...
        var n = this;
        x(0 === this.rl(e.batchId, "removed")), this.vr.shift();
        var r = this.el;
        return _r.forEach(e.mutations, (function(i) {
        ...
        var n = new Po(e, 0), r = this.el.xt(n);
        return _r.resolve(e.isEqual(r && r.key));
    }, t.prototype.Go = function(t) {
        return this.vr.length, _r.resolve();
    }, 
    /**
    ...
    t.prototype.Ir = function(t) {
        ...
        for (var r = zt(), i = new M(e.path.child("")), o = this.docs._t(i)
        ...
        return _r.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.aa = function(e) {
...
var nu = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.hl = new Lo, this.targetCount = 0, this.ll = ho.ma();
    }
    return t.prototype.De = function(t, e) {
        ...
        return _r.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Pa = function(t) {
        return _r.resolve(this.ul);
    }, t.prototype.Ea = function(t) {
        return this.highestTargetId = this.ll.next(), _r.resolve(this.highestTargetId);
    }, t.prototype.ga = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.ll = new ho(e), this.highestTargetId = e), t.sequenceNumber > this.ul && (this.ul = t.sequenceNumber);
    }, t.prototype.ya = function(t, e) {
        return this.Va(e), this.targetCount += 1, _r.resolve();
    }, t.prototype.ba = function(t, e) {
        return this.Va(e), _r.resolve();
    }, t.prototype.va = function(t, e) {
        ...
        return this.cl.forEach((function(s, u) {
            ...
            i++);
        })), _r.xn(o).next((function() {
            return i;
        }));
    }, t.prototype.Da = function(t) {
        return _r.resolve(this.targetCount);
    }, t.prototype.Ca = function(t, e) {
        var n = this.cl.get(e) || null;
        return _r.resolve(n);
    }, t.prototype.Na = function(t, e, n) {
        return this.hl.qc(e, n), _r.resolve();
    }, t.prototype.xa = function(t, e, n) {
        this.hl.Qc(e, n);
        ...
        return this.hl.Wc(e), _r.resolve();
    }, t.prototype.ka = function(t, e) {
        var n = this.hl.Kc(e);
        return _r.resolve(n);
    }, t.prototype.zo = function(t, e) {
        return _r.resolve(this.hl.zo(e));
    }, t;
}(), ru = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this._l = {}, this.Ba = new Hr(0), this.qa = !1, this.qa = !0, this.Co = t(this), 
        this.Ha = new nu(this), this.Sr = new Bi, this.br = new eu(this.Sr, (function(t) {
            return e.Co.fl(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this._l[t.Zs()];
        return e || (e = new tu(this.Sr, this.Co), this._l[t.Zs()] = e), e;
    }, t.prototype.Ac = function() {
        return this.Ha;
    }, t.prototype.Rc = function() {
        return this.br;
        ...
        return _r.$n(Object.values(this._l).map((function(n) {
            return function() {
                return n.zo(t, e);
            };
        })));
    ...
    return t.Il = function(e) {
        ...
        return this.Tl.Fa(n, e), this.Al.delete(n.toString()), _r.resolve();
    }, t.prototype.$a = function(t, e, n) {
        return this.Tl.$a(n, e), this.Al.add(n.toString()), _r.resolve();
    }, t.prototype.Ko = function(t, e) {
        return this.Al.add(e.toString()), _r.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return _r.forEach(this.Al, (function(r) {
            var i = M.D(r);
    ...
    return t(n, e), n.prototype.$l = function(t, e, n, r) {
            ...
            s.listenOnce(v.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case y.TIMEOUT:
                        _("Connection", 'RPC "' + t + '" timed out'), o(new I(b.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case y.HTTP_ERROR:
                        var n = s.getStatus();
                        if (_("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
        ...
        var n = [ this.Cl, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = m(), i = {
        ...
        this.xl(i.initMessageHeaders, e), 
        ...
        var o = n.join("");
        _("Connection", "Creating WebChannel: " + o, i);
        var s = r.createWebChannel(o, i), u = !1, d = !1, v = new su({
            Pl: function(t) {
                d ? _("Connection", "Not sending because WebChannel is closed:", t) : (u || (_("Connection", "Opening WebChannel transport."), 
                s.open(), u = !0), _("Connection", "WebChannel sending:", t), s.send(t));
            },
            gl: function() {
                return s.close();
            }
        ...
        return y(g.EventType.OPEN, (function() {
            d || _("Connection", "WebChannel transport opened.");
        })), y(g.EventType.CLOSE, (function() {
            d || (d = !0, _("Connection", "WebChannel transport closed"), v.vl());
            ...
            if (!d) {
                ...
                } else _("Connection", "WebChannel received:", n), v.Sl(n);
            }
        })), setTimeout((function() {
 ...
 */ var lu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", pu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Nh = this.Ul(t), this.persistence = this.Ql(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.Wl = this.jl(t), this.zu = this.Kl(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new $s, r = t.Gl, new _o(e, n, r);
        var e, n, r;
    }, t.prototype.Ql = function(t) {
        if (t.persistenceSettings.zl) throw new I(b.FAILED_PRECONDITION, lu);
        return new ru(ou.Il);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Hl._i, this.Nh instanceof ri ? (this.Nh._i = {
                        tr: Gs.bind(null, i),
                        er: Ys.bind(null, i),
                        nr: Xs.bind(null, i),
                        Vi: Hs.bind(null, i)
                    ...
                    return [ 4 /*yield*/ , this.persistence.ec((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Qs(this.Hl._i, t) ];

                                  case 1:
                                    return e.sent(), this.Wl && (t && !this.Wl.Ti ? this.Wl.start(this.zu) : t || this.Wl.stop()), 
                                    [ 2 /*return*/ ];
                                }
                            }));
                        }));
        ...
        if (t.persistenceSettings.zl && t.persistenceSettings.synchronizeTabs) {
            ...
            var n = To(t.Dl.U, t.Dl.persistenceKey);
            return new ri(e, t.os, n, t.clientId, t.Gl);
        }
        return new ii;
    }, i;
}(/** @class */ function(r) {
    function i(t) {
        var e = this;
        return (e = r.call(this) || this).Hl = t, e;
    }
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return i.sent(), [ 4 /*yield*/ , this.Hl.initialize(this, t) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return i.sent(), [ 4 /*yield*/ , Js(this.Hl._i) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return i.sent(), [ 4 /*yield*/ , cs(this.Hl.Dh) ];
        ...
        var e = To(t.Dl.U, t.Dl.persistenceKey), n = fu(t.Dl.U);
        return new go(t.persistenceSettings.synchronizeTabs, e, t.clientId, vi.oo(t.persistenceSettings.cacheSizeBytes), t.os, Lr(), Pr(), n, this.Nh, t.persistenceSettings.La);
    }, i.prototype.Ul = function(t) {
        return new ii;
    ...
    return t.prototype.initialize = function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.zu ? [ 3 /*break*/ , 2 ] : (this.zu = t.zu, this.Nh = t.Nh, this.Hu = this.Yl(r), 
                    this.Dh = this.Jl(r), this.Ch = this.Xl(r), this._i = this.Zl(r), this.Nh.fi = function(t) {
                        return xs(e._i, t, 1 /* SharedClientState */);
                    }, this.Dh.Yu.t_ = js.bind(null, this._i), [ 4 /*yield*/ , ys(this.Dh, this._i.jh) ]);
        ...
        var e, n = fu(t.Dl.U), r = (e = t.Dl, new au(e));
        ...
        }, o = cu.On() ? new cu : new hu, new Wo(e, n, r, i, o);
    }, t.prototype.Zl = function(t) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new _s(t, e, n, r, i, o);
            return s && (u.Wh = !0), u;
    ...
    for (var e = 0; e < t.length; ++e) if (B("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new I(b.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.s_ = new C(t);
}, gu = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.o_ = function(t) {
...
var Tu = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.o_ = function(t) {
        var e = new pn(t.serializer, xe(t.serializer, this.__));
    ...
    return t(n, e), n.delete = function() {
        return F("FieldValue.delete", arguments), new Su(new Iu("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return F("FieldValue.serverTimestamp", arguments), new Su(new Tu("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return j("FieldValue.arrayUnion", arguments, 1), new Su(new _u("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return j("FieldValue.arrayRemove", arguments, 1), new Su(new Nu("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return B("FieldValue.increment", "number", 1, t), q("FieldValue.increment", arguments, 1), 
        new Su(new Au("FieldValue.increment", t));
    }, n;
...
}(Du), xu = /** @class */ function() {
    function t(t, e) {
        if (q("GeoPoint", arguments, 2), B("GeoPoint", "number", 1, t), B("GeoPoint", "number", 2, e), 
    ...
    return t.prototype.E_ = function(t, e) {
        var n = [];
        return null !== this.Qe ? n.push(new Sn(t, this.data, this.Qe, e)) : n.push(new Dn(t, this.data, e)), 
...
/** A "context" object passed around while parsing user data. */ var Pu = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.A_ = function(e) {
        ...
        return Ku(t, this.settings.methodName, this.settings.V_ || !1, this.path, this.settings.u_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Lu(this.a_) && ku.test(t)) throw this.c_('Document fields cannot begin and end with "__"');
    }, t;
}(), Vu = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse update data from an update() call. */ function Mu(t, e, n, r) {
    ...
    Gu("Data must be an object, but it was:", i, r);
    var o = [], s = new Vn;
    R(r, (function(t, r) {
        var u = Wu(e, t, n), a = i.g_(u);
        if (r instanceof bu && r.i_ instanceof Iu) 
...
/** Parse update data from a list of field/value arguments. */ function Fu(t, e, n, r, i, o) {
    ...
    for (var h = [], f = new Vn, l = u.length - 1; l >= 0; --l) if (!Hu(h, u[l])) {
        var p = u[l], d = a[l], v = s.g_(p);
        if (d instanceof bu && d.i_ instanceof Iu) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var y = ju(d, v);
    ...
    var m = new yn(h);
    return new Uu(f.Je(), m, s.fieldTransforms);
}
 ...
 */ function qu(t, e, n, r) {
    return void 0 === r && (r = !1), ju(n, t.p_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ju(t, e) {
    if (Bu(t)) return Gu("Unsupported field value:", e, t), zu(t, e);
    if (t instanceof bu) 
    ...
    return function(t, e) {
        ...
        if (!Lu(e.a_)) throw e.c_(t.r_ + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof Ou) {
            ...
            return {
                referenceValue: Le(t.w_ || e.U, t.m_.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.c_("Unsupported field value: " + Z(t));
    }(t, e);
}
 ...
 */ function Qu(t, e, n) {
    if (e instanceof mu) return e.s_;
 ...
 */ var Yu = /** @class */ function() {
    ...
    return t.prototype.C_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.N_(), this.mutations.length > 0) throw new I(b.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.Lu("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = n.sent(), u = new Map, s.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Ce(t, e.found.name), r = Ue(e.found.updateTime), i = new Pn({
                                                    mapValue: {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof qn || t instanceof Fn ? i.F_(t) : S();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new Un(t, this.Ke(t)) ]), this.D_.add(t.toString());
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = M.D(e);
                        r.mutations.push(new Ln(n, r.Ke(n)));
    ...
    t.prototype.Ke = function(t) {
        ...
        return !this.D_.has(t.toString()) && e ? wn.updateTime(e) : wn.Ge();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.os = t, this.Hu = e, this.updateFunction = n, this.hs = r, this.k_ = 5, this.gs = new Tr(this.os, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.gs.Rn((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Yu(this.Hu), (e = this.O_(t)) && e.then((function(e) {
                        r.os.ds((function() {
    ...
    return t.prototype.start = function(t, r, i, o) {
        ...
        return this.credentials.Jc((function(t) {
            if (!a) return a = !0, _("FirestoreClient", "Initializing. user=", t.uid), s.Q_(r, i, o, t, u).then(s.q_.resolve, s.q_.reject);
            s.os.Ds((function() {
                return function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return (e = k(t)).os.Fs(), _("RemoteStore", "RemoteStore received new credentials"), 
                                i = ns(e), 
                                // Tear down and re-create our network streams. This will ensure we get a
                                // fresh auth token for the new user and re-fill the write pipeline with
                                // new mutations from the LocalStore (since mutations are per-user).
                                e.Zu.add(3 /* CredentialChange */), [ 4 /*yield*/ , Ho(e) ];

                              case 1:
                                return n.sent(), i && 
                                // Don't set the network status to Unknown if we are offline.
                                e.sh.set("Unknown" /* Unknown */), [ 4 /*yield*/ , e.Yu.t_(r) ];

                              case 2:
                                return n.sent(), e.Zu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Ko(e) ];
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        ...
        return this.U_(), this.os.enqueue((function() {
            return t.persistence.sc(!0), function(t) {
                var e = k(t);
                return e.Zu.delete(0 /* UserDisabled */), Ko(e);
            }(t.Dh);
        }));
    }, 
    /**
     ...
     *     succeeded.
     */
    t.prototype.Q_ = function(t, r, i, o, s) {
        return e(this, void 0, void 0, (function() {
            var u, a, c = this;
            return n(this, (function(h) {
                switch (h.label) {
                  ...
                  case 2:
                    return h.sent(), this.persistence = t.persistence, this.Nh = t.Nh, this.zu = t.zu, 
                    this.Wl = t.Wl, this.Hu = r.Hu, this.Dh = r.Dh, this._i = r._i, this.W_ = r.Ch, 
                    this.W_.qs = Ns.bind(null, this._i), this.W_.Ws = Ds.bind(null, this._i), 
            ...
            return t.persistence.sc(!1), function(t) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return (e = k(t)).Zu.add(0 /* UserDisabled */), [ 4 /*yield*/ , Ho(e) ];

                          case 1:
                            return n.sent(), 
                            // Set the OnlineState to Offline so get()s return from cache, etc.
                            e.sh.set("Offline" /* Offline */), [ 2 /*return*/ ];
                        }
                    }));
                }));
            }(t.Dh);
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        ...
                        this.Wl && this.Wl.stop(), [ 4 /*yield*/ , Yo(this.Dh) ];

                      case 1:
                        return n.sent(), [ 4 /*yield*/ , this.Nh.Si() ];
            ...
            return function(t, r) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            ns((e = k(t)).Dh) || _("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                            n.label = 1;
                          ...
                          case 2:
                            return -1 === (i = n.sent()) ? [ 2 /*return*/ , void r.resolve() ] : ((o = e.Uh.get(i) || []).push(r), 
                            e.Uh.set(i, o), [ 3 /*break*/ , 4 ]);
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return e = n.sent(), o = new Is(r, e.kc), s = o.Eh(e.documents), u = o.gr(s, 
                ...
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                                ...
                                return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                                    return r.xc.$r(t, o).next((function(o) {
                                        ...
                                        var s = [], u = 0, a = e; u < a.length; u++) {
                                            var c = a[u], h = _n(c, n.get(c.key));
                                            null != h && 
                                            // NOTE: The base state should only be applied if there's some
                                            // existing document to override, so use a Precondition of
                                            // exists=true
                                            s.push(new Sn(c.key, h, Cn(h.proto.mapValue), wn.exists(!0)));
                                        }
                          ...
                          case 2:
                            return o = n.sent(), e.Nh.Fi(o.batchId), function(t, e, n) {
                                var r = t.qh[t.currentUser.Zs()];
                                r || (r = new Ut(st)), r = r.rt(e, n), t.qh[t.currentUser.Zs()] = r;
                            }(e, o.batchId, i), [ 4 /*yield*/ , qs(e, o.dr) ];

                          case 3:
                            return n.sent(), [ 4 /*yield*/ , cs(e.Dh) ];
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Er;
        return this.os.ds((function() {
            return new Xu(e.os, e.Hu, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var $u = /** @class */ function() {
    ...
    return t.prototype.ef = function(t) {
        switch (ce(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.tf(me(t.bytesValue));
    ...
    function t(t) {
        ...
        if ($("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        ...
        W("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = vi.lo; else {
            if (t.cacheSizeBytes !== ta && t.cacheSizeBytes < vi.ho) throw new I(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + vi.ho);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new pu), void 0 === s && (s = new vu), this.uf = o, this.hf = s, 
        this.lf = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this._f = new Cr, this.INTERNAL = {
            delete: function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
            ...
            var a = r;
            this.lf = a, this.w_ = t.wf(a), this.mf = a.name, this.Tf = new Mo(i);
        } else {
            var c = r;
            if (!c.projectId) throw new I(b.INVALID_ARGUMENT, "Must provide projectId");
            this.w_ = new vt(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.mf = "[DEFAULT]", this.Tf = new Co;
        }
        this.Ef = new ea({});
    }
    return Object.defineProperty(t.prototype, "If", {
        get: function() {
            ...
            this.Af = new Vu(this.w_, this.Ef.ignoreUndefinedProperties)), this.Af;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        q("Firestore.settings", arguments, 1), B("Firestore.settings", "object", 1, t), 
        t.merge && 
        // Remove the property from the settings once the merge is completed
        delete (t = Object.assign(Object.assign({}, this.Ef), t)).merge;
        var e = new ea(t);
        if (this.df && !this.Ef.isEqual(e)) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.df) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.df && !this.df.J_) throw new I(b.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Er, [ 2 /*return*/ , (this._f.ps((function() {
                    return e(r, void 0, void 0, (function() {
                        var e;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.uf.clearPersistence(this.w_, this.mf) ];
    ...
    }, Object.defineProperty(t.prototype, "gf", {
        get: function() {
        ...
        if (this.ff(), Ju(t)) return this.df.Y_(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Pf(new pu, new vu, {
            zl: !1
        }), this.df;
    }, t.prototype.yf = function() {
        return new dt(this.w_, this.mf, this.Ef.host, this.Ef.ssl, this.Ef.experimentalForceLongPolling);
    }, t.prototype.Pf = function(t, e, n) {
        var r = this.yf();
        return this.df = new Zu(this.Tf, this._f), this.df.start(r, t, e, n);
    }, t.wf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I(b.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.lf) throw new I(b.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.lf;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return q("Firestore.collection", arguments, 1), B("Firestore.collection", "non-empty string", 1, t), 
        this.ff(), new ma(P.P(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return q("Firestore.doc", arguments, 1), B("Firestore.doc", "non-empty string", 1, t), 
        this.ff(), oa.Vf(P.P(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (q("Firestore.collectionGroup", arguments, 1), B("Firestore.collectionGroup", "non-empty string", 1, t), 
 ...
 */
        ...
        var e = this;
        return q("Firestore.runTransaction", arguments, 1), B("Firestore.runTransaction", "function", 1, t), 
        this.ff().transaction((function(n) {
            return t(new ra(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.ff(), new ia(this);
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Ia("Transaction.get", t, this.vf);
        return this.Sf.C_([ n.m_ ]).then((function(t) {
            if (!t || 1 !== t.length) return S();
            var r = t[0];
            if (r instanceof qn) return new ua(e.vf, n.m_, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.T_);
            if (r instanceof Fn) return new ua(e.vf, n.m_, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.T_);
            throw S();
        }));
        ...
        var r = Ia("Transaction.set", t, this.vf);
        n = ga("Transaction.set", n);
        var i = Ta(r.T_, e, n), o = Cu(this.vf.If, "Transaction.set", r.m_, i, null !== r.T_, n);
        return this.Sf.set(r.m_, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof gu ? (j("Transaction.update", arguments, 3), 
        r = Ia("Transaction.update", t, this.vf), i = Fu(this.vf.If, "Transaction.update", r.m_, e, n, o)) : (q("Transaction.update", arguments, 2), 
        r = Ia("Transaction.update", t, this.vf), i = Mu(this.vf.If, "Transaction.update", r.m_, e)), 
        this.Sf.update(r.m_, i), this;
    }, t.prototype.delete = function(t) {
        q("Transaction.delete", arguments, 1);
        var e = Ia("Transaction.delete", t, this.vf);
    ...
    return t.prototype.set = function(t, e, n) {
        z("WriteBatch.set", arguments, 2, 3), this.Nf();
        var r = Ia("WriteBatch.set", t, this.vf);
        n = ga("WriteBatch.set", n);
        var i = Ta(r.T_, e, n), o = Cu(this.vf.If, "WriteBatch.set", r.m_, i, null !== r.T_, n);
        return this.Df = this.Df.concat(o.E_(r.m_, wn.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Nf(), "string" == typeof e || e instanceof gu ? (j("WriteBatch.update", arguments, 3), 
        r = Ia("WriteBatch.update", t, this.vf), i = Fu(this.vf.If, "WriteBatch.update", r.m_, e, n, o)) : (q("WriteBatch.update", arguments, 2), 
        r = Ia("WriteBatch.update", t, this.vf), i = Mu(this.vf.If, "WriteBatch.update", r.m_, e)), 
        this.Df = this.Df.concat(i.E_(r.m_, wn.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        q("WriteBatch.delete", arguments, 1), this.Nf();
        var e = Ia("WriteBatch.delete", t, this.vf);
        return this.Df = this.Df.concat(new Un(e.m_, wn.Ge())), this;
    }, t.prototype.commit = function() {
        return this.Nf(), this.Cf = !0, this.Df.length > 0 ? this.vf.ff().write(this.Df) : Promise.resolve();
    }, t.prototype.Nf = function() {
        if (this.Cf) throw new I(b.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), oa = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.Vf = function(t, e, r) {
        ...
        get: function() {
            return new ma(this.m_.path.h(), this.firestore, this.T_);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (q("DocumentReference.collection", arguments, 1), B("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new I(b.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = P.P(t);
        return new ma(this.m_.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        ...
        z("DocumentReference.set", arguments, 1, 2), e = ga("DocumentReference.set", e);
        var n = Ta(this.T_, t, e), r = Cu(this.firestore.If, "DocumentReference.set", this.m_, n, null !== this.T_, e);
        return this.df.write(r.E_(this.m_, wn.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof gu ? (j("DocumentReference.update", arguments, 2), 
        n = Fu(this.firestore.If, "DocumentReference.update", this.m_, t, e, r)) : (q("DocumentReference.update", arguments, 1), 
        n = Mu(this.firestore.If, "DocumentReference.update", this.m_, t)), this.df.write(n.E_(this.m_, wn.exists(!0)));
    }, n.prototype.delete = function() {
        return q("DocumentReference.delete", arguments, 0), this.df.write([ new Un(this.m_, wn.Ge()) ]);
        ...
        "object" != typeof i[u] || Ju(i[u]) || ($("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        return this.df.listen(Gn(this.m_.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        z("DocumentReference.get", arguments, 0, 1), ba("DocumentReference.get", t);
        var n = this.firestore.ff();
        return t && "cache" === t.source ? n.K_(this.m_).then((function(t) {
            return new ua(e.firestore, e.m_, t, 
            /*fromCache=*/ !0, t instanceof Fn && t.Ye, e.T_);
    ...
    n.prototype.Ff = function(t) {
        ...
        return new ua(this.firestore, this.m_, e, t.fromCache, t.hasPendingWrites, this.T_);
    }, n;
}(Ou), sa = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (z("DocumentSnapshot.data", arguments, 0, 1), t = wa("DocumentSnapshot.data", t), 
        this.xf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.T_) {
                var n = new aa(this.vf, this.m_, this.xf, this.$f, this.kf, 
                /* converter= */ null);
                return this.T_.fromFirestore(n, t);
            }
            return new $u(this.vf.w_, this.vf.pf(), t.serverTimestamps || "none", (function(t) {
                return new oa(t, e.vf, /* converter= */ null);
            }), (function(t) {
                return new pt(t);
            })).ef(this.xf.sn());
        }
        ...
        var n = this;
        if (z("DocumentSnapshot.get", arguments, 1, 2), e = wa("DocumentSnapshot.get", e), 
        this.xf) {
            var r = this.xf.data().field(Qu("DocumentSnapshot.get", t, this.m_));
            if (null !== r) return new $u(this.vf.w_, this.vf.pf(), e.serverTimestamps || "none", (function(t) {
                return new oa(t, n.vf, n.T_);
            }), (function(t) {
                return new pt(t);
            })).ef(r);
        }
        ...
        get: function() {
            return new oa(this.m_, this.vf, this.T_);
        },
        enumerable: !1,
        configurable: !0
...
function ca(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || la(s, o), 
    u = qu(n, e, s, 
...
function fa(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Yn(e) && -1 !== n.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof Ou) return ge(t, n.m_);
    throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Z(n) + ".");
}
...
function da(t) {
    if (Wn(t) && 0 === t.rn.length) throw new I(b.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var va = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i = H("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = Qu("Query.where", e), s = ca(this.Mf, "Query.where", this.firestore.If, this.firestore.w_, o, i, r);
        ...
        var r;
        if (z("Query.orderBy", arguments, 1, 2), G("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Qu("Query.orderBy", e), o = ha(this.Mf, i, r);
        return new t(function(t, e) {
        ...
        return q("Query.limit", arguments, 1), B("Query.limit", "number", 1, e), et("Query.limit", 1, e), 
        new t(Jn(this.Mf, e, "F" /* First */), this.firestore, this.T_);
    }, t.prototype.limitToLast = function(e) {
        return q("Query.limitToLast", arguments, 1), B("Query.limitToLast", "number", 1, e), 
        et("Query.limitToLast", 1, e), new t(Jn(this.Mf, e, "L" /* Last */), this.firestore, this.T_);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        j("Query.startAt", arguments, 1);
        var i = this.Of("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t($n(this.Mf, i), this.firestore, this.T_);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        j("Query.startAfter", arguments, 1);
        var i = this.Of("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t($n(this.Mf, i), this.firestore, this.T_);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        j("Query.endBefore", arguments, 1);
        var i = this.Of("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(tr(this.Mf, i), this.firestore, this.T_);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        j("Query.endAt", arguments, 1);
        var i = this.Of("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(tr(this.Mf, i), this.firestore, this.T_);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw tt("isEqual", "Query", 1, e);
        return this.firestore === e.firestore && er(this.Mf, e.Mf) && this.T_ === e.T_;
    }, t.prototype.withConverter = function(e) {
        return new t(this.Mf, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.Of = function(t, e, n, i) {
        if (J(t, 1, e), e instanceof ua) return q(t, r([ e ], n), 1), function(t, e, n, r, i) {
            ...
            // results.
            for (var o = [], s = 0, u = Xn(t); s < u.length; s++) {
                var a = u[s];
            ...
            return new vr(o, i);
        }(this.Mf, this.firestore.w_, t, e.xf, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.p()) {
                    ...
                    if (!Yn(t) && -1 !== c.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
            ...
            return new vr(u, o);
        }(this.Mf, this.firestore.w_, this.firestore.If, t, o, i);
    }, t.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        z("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Ju(i[u]) || ($("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        var c = {
            next: function(t) {
                i[u] && i[u](new ya(r.firestore, r.Mf, t, r.T_));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return da(this.Mf), this.firestore.ff().listen(this.Mf, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        z("Query.get", arguments, 0, 1), ba("Query.get", t), da(this.Mf);
        var n = this.firestore.ff();
        return (t && "cache" === t.source ? n.z_(this.Mf) : n.H_(this.Mf, t)).then((function(t) {
            return new ya(e.firestore, e.Mf, t, e.T_);
        }));
    }, t;
}(), ya = /** @class */ function() {
    function t(t, e, n, r) {
        this.vf = t, this.Lf = e, this.Bf = n, this.T_ = r, this.qf = null, this.Uf = null, 
        this.metadata = new sa(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        z("QuerySnapshot.forEach", arguments, 1, 2), B("QuerySnapshot.forEach", "function", 1, t), 
        this.Bf.docs.forEach((function(r) {
            t.call(e, n.Qf(r, n.metadata.fromCache, n.Bf.Qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new va(this.Lf, this.vf, this.T_);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (e && this.Bf.jt) throw new I(b.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.vf === e.vf && er(this.Lf, e.Lf) && this.Bf.isEqual(e.Bf) && this.T_ === e.T_;
    }, t.prototype.Qf = function(t, e, n) {
        return new aa(this.vf, t.key, t, e, n, this.T_);
    }, t;
}(), ma = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Gn(t), n, r) || this).Wf = t, t.length % 2 != 1) throw new I(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.R() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.m() ? null : new oa(new M(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        z("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ot.k()), B("CollectionReference.doc", "non-empty string", 1, t);
        var e = P.P(t);
        return oa.Vf(this.Mf.path.child(e), this.firestore, this.T_);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new oa(n.m_, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
...
function ga(t, e) {
    ...
    if ($(t, e, [ "merge", "mergeFields" ]), W(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new I(b.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Z(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new I(b.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Z(r[o]));
        }(t, e, n, r, i);
...
function wa(t, e) {
    return void 0 === e ? {} : ($(t, e, [ "serverTimestamps" ]), K(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function ba(t, e) {
    G(t, "object", 1, e), e && ($(t, e, [ "source" ]), K(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var _a = {
    ...
    FieldPath: gu,
    FieldValue: Du,
    setLogLevel: na.setLogLevel,
    CACHE_SIZE_UNLIMITED: ta
};
