    ...
    return (
        <div className="about-page border-01 top-left-shadow">
          <div className="about-container">
            ...
            <p>Ranald's Gift is a project developed by myself, <a className="link" href="/user/eKauxjk0DsWcwKr2d2QU0rENB5x1/view">B-Fir3</a>, and other community contributors such as <span className="link">Craven</span> and <span className="link">Esawo</span>. You can see a full list of contributors for the current project <a href="https://github.com/ranaldsgift/ranalds.gift/graphs/contributors">here</a>, and for the old project <a href="https://github.com/ranaldsgift/ranaldsgift/graphs/contributors">here</a>. If you would like to contribute, you can find the project on github <a href="https://github.com/ranaldsgift/ranalds.gift">here</a>.</p>
