export const MELEE_PROPERTY1_INDEX = 0;
export const MELEE_PROPERTY2_INDEX = 1;
export const MELEE_TRAIT_INDEX = 0;
export const RANGE_PROPERTY1_INDEX = 2;
export const RANGE_PROPERTY2_INDEX = 3;
export const RANGE_TRAIT_INDEX = 1;
